...
INSERT INTO privilege (pname,purl,isleft) values ('订单管理','forderAction_all',true);
INSERT INTO privilege (pname,purl,isleft) values ('会员管理','usersAction_all',true);
...
INSERT INTO role (rname,rdetail)VALUES ('客服','拥有查询订单......的权限')

SELECT * FROM role_privilege;

INSERT INTO role_privilege (rid,pid) values (1,13);
INSERT INTO role_privilege (rid,pid) values (1,5);
INSERT INTO role_privilege (rid,pid) values (1,8);

SELECT * FROM role r inner join role_privilege rp on r.rid=rp.rid 
inner join privilege p on rp.pid=p.pid 

SELECT * FROM goods;
SELECT * FROM privilege p where p.parentId is null;
